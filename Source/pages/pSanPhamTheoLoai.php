<h1 id="1111" style ="text-align: center; font-weight: bold;"><a href="#">Sản phẩm theo loại</a></h1>
<div id="pagesAjax">
<?php
    if(isset($_GET["id"]))
        $id = $_GET["id"];
...
<script>
    function loadPrePage(page, id, numOfPages){
        ...
        xhttp.open("GET", "pages/Ajax/pAjaxPaginationSanPhamTheoLoai.php?p="+page+"&id="+id+"&ps="+numOfPages, true);
        xhttp.send();
    }
